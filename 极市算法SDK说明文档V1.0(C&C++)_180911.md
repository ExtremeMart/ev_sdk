...
| 版本 |              内容说明               | 编写人 |  更新时间  |
| :--: | :---------------------------------: | :----: | :--------: |
| V1.2 | 更新接口参数说明 | YuanCheng.Huang | 2018/09/29 |
...
- **demo.cpp**  # 调用ji.cpp实现的接口(推荐使用 极市demo.cpp，请不要在demo.cpp内写自定义的.h文件  ji_util.hpp除外（这个是极市推荐的图片转buffer接口 .h[文件](./convert_File2Buffer)）)
